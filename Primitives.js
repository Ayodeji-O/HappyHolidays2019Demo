...
Point3d.prototype.distanceFrom = function(secondPoint) {
	...
	if (validateVarAgainstType(secondPoint, Point3d)) {
 ...
 */
Point3d.prototype.rotatePointCopy = function(rotationCenterPoint, degrees) {
...
Vector3d.prototype.addVector = function(secondVector3d) {
	...
	if (validateVarAgainstType(secondVector3d, Vector3d)) {
...
Vertex3d.prototype.setNormalVector = function(normalVector3d) {
	if (validateVarAgainstType(normalVector3d, Vector3d)) {
...
function Triangle(firstVertex3d, secondVertex3d, thirdVertex3d) {
	...
	if (validateVarAgainstType(firstVertex3d, Vertex3d) &&
		validateVarAgainstType(secondVertex3d, Vertex3d) &&
		validateVarAgainstType(thirdVertex3d, Vertex3d)) {
...
Triangle.prototype.isValid = function() {
	return (validateVarAgainstType(this.firstVertex3d, Vertex3d) &&
		validateVarAgainstType(this.secondVertex3d, Vertex3d) &&
		validateVarAgainstType(this.thirdPoint3d, Vertex3d));
}
